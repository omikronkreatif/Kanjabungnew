...
class entry_gdfp(models.Model):
    ...
    petugas = fields.Many2one('medical.physician', 'Petugas')
    jenis_kunjungan = fields.Many2one('master.jenis.kunjungan', 'Jenis kunjungan')
    ...
    nilai_bk_jerami = fields.Float('BK Jerami', default=0.80, digits=(3, 2), readonly=True)
    ...
    nilai_bk_gajah = fields.Float('BK Gajah', default=0.21, digits=(3, 2), readonly=True)
    ...
    total_tdn = fields.Float('Total', compute='hitung_total_tdn')
    #tabel kebutuhan tdn pakan
    ...
    bk_tersedia_jerami = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_jerami')
    tdn_tersedia_jerami = fields.Float('TDN Tersedia', compute='hitung_tdn_jerami_padi')
    bk_tersedia_gajah = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_gajah')
    tdn_tersedia_gajah = fields.Float('TDN Tersedia', compute='hitung_tdn_rumput_gajah')
    bk_tersedia_tebon = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_tebon')
    tdn_tersedia_tebon = fields.Float('TDN Tersedia', compute='hitung_tdn_rumput_tebon')
    bk_tersedia_tebu = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_tebu')
    tdn_tersedia_tebu = fields.Float('TDN Tersedia', compute='hitung_tdn_rumput_tebu')
    bk_tersedia_pakchong = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_pakchong')
    tdn_tersedia_pakchong = fields.Float('TDN Tersedia', compute='hitung_tdn_rumput_pakchong')
    bk_tersedia_odot = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_odot')
    tdn_tersedia_odot = fields.Float('TDN Tersedia', compute='hitung_tdn_rumput_odot')
    bk_tersedia_lapang = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_lapang')
    tdn_tersedia_lapang = fields.Float('TDN Tersedia', compute='hitung_tdn_rumput_lapang')
    #tabel penghitungan tdn dan bk pakan konsentrat
    bk_tersedia_plus = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_plus')
    tdn_tersedia_plus = fields.Float('TDN Tersedia', compute='hitung_tdn_kons_plus')
    bk_tersedia_2a = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_2a')
    tdn_tersedia_2a = fields.Float('TDN Tersedia', compute='hitung_tdn_kons_2a')
    bk_tersedia_mapan = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_mapan')
    tdn_tersedia_mapan = fields.Float('TDN Tersedia', compute='hitung_tdn_kons_mapan')
    bk_tersedia_feed = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_feed')
    tdn_tersedia_feed = fields.Float('TDN Tersedia', compute='hitung_tdn_kons_feed')
    #tabel penghitungan tdn dan bk pakan tambah
    bk_tersedia_selep = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_selep')
    tdn_tersedia_selep = fields.Float('TDN Tersedia', compute='hitung_tdn_tersedia_selep')
    bk_tersedia_tawar = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_tawar')
    tdn_tersedia_tawar = fields.Float('TDN Tersedia', compute='hitung_tdn_tersedia_tawar')
    bk_tersedia_singkong = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_singkong')
    tdn_tersedia_singkong = fields.Float('TDN Tersedia', compute='hitung_tdn_tersedia_singkong')
    bk_tersedia_gamblong = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_gamblong')
    tdn_tersedia_gamblong = fields.Float('TDN Tersedia', compute='hitung_tdn_tersedia_gamblong')
    bk_tersedia_bir = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_bir')
    tdn_tersedia_bir = fields.Float('TDN Tersedia', compute='hitung_tdn_tersedia_bir')
    bk_tersedia_tahu = fields.Float('BK Tersedia', compute='hitung_bk_tersedia_tahu')
    tdn_tersedia_tahu = fields.Float('TDN Tersedia', compute='hitung_tdn_tersedia_tahu')
    ...
    def hitung_bk_tersedia_bir(self):
        for record in self:
            record.bk_tersedia_bir = record.nilai_bk_gamblong * record.juml_tambah_bir

    @api.depends('nilai_tdn_bir', 'bk_tersedia_bir')
    def hitung_tdn_tersedia_bir(self):
        for record in self:
            record.tdn_tersedia_bir = record.nilai_tdn_gamblong * record.bk_tersedia_bir * 1000
    ...
    ], string='Kecukupan Pakan', required=True)
...
class GDFPSapiLine(models.Model):
    ...
    sapi_id = fields.Many2one('sapi', string='Sapi', domain="[('peternak_id', '=', peternak_id)]")
    bobot_badan = fields.Float('Bobot Badan')
    ...
    reproduksi = fields.Float('Reproduksi', compute='_compute_reproduksi_sapi', store=True, readonly=True)
    hidup_pokok = fields.Float('Hidup Pokok', default=7.5, readonly=True)
    produksi = fields.Float('Produksi', default=326, readonly=True)
